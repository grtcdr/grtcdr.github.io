#+TITLE: grtcdr: purely org site
#+DATE: <2022-05-18>
#+SETUPFILE: .setup.org
#+INCLUDE: .nav.org

* Purely Org site :org:emacs:
...
should go upon export. Allow me to show you the project structure to
help you visualize the layout of the project.
