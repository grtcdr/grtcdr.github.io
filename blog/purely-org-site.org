...
a daily basis. I wanted to make a difference with my little
personal corner of the internet. What do you know? /Emacs can totally do that/.

You see, Emacs comes with an exceptional tool called Org, that comes
with many wonderful functions. That which powers this entire website
goes by ~org-publish-project-alist~.

In short, you specify where a particular =$thing= is, and where it
should go upon export.

* Getting started

I want to introduce you to the most basic form of a working ~org-publish-project-alist~:
...
What happens you create a =.org= document within your =:base-directory= -- save
it -- hit =M-x org-publish RET=, is simply magical!
...
(use-package ox-publish
  ...
  (org-publish-project-alist
	`(("grtcdr.github.io/org"
	  ...
	  ("grtcdr.github.io" :components ("grtcdr.github.io/img" "grtcdr.github.io/data" "grtcdr.github.io/css" "grtcdr.github.io/org")))))
#+end_src
...
Allow me to show you the project structure to help you visualize the
...
I won't document every single property, because that would be a
disservice to the wonderful, and much more detailed [[https://orgmode.org/worg/org-tutorials/org-publish-html-tutorial.html][documentation provided by the Org project]].
