...
hosts onto the network, but behind the scenes, they are actually on a
subnet whose router is [[https://tldp.org/HOWTO/Adv-Routing-HOWTO/lartc.bridging.proxy-arp.html][proxying ARP requests/replies]].
...
Name=<softap>
Kind=wlan
Description=vNIC for a software-enabled access point
#+end_src
...
new software-enabled access point - which I decided to call "jungle"
