...
- [[file:dots/sway/sway.org][sway et al.]]: A concoction of subtlety and elegance, making use of the bear
...
- [[file:dots/sh/mus.org][mus]]: A shell script to automate the starting and stopping of =mpd=
  and =ncmpcpp=.
