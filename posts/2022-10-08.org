...
We're going to build on top of [[https://git.sr.ht/~bzg/org-mode/tree/main/item/lisp/ox-html.el][ox-html]], and we're going to make sure
...
how GitHub references source files, and that we dissect the URLs'
various components. For example, the URL of my first ever blog,
"Building a website with Emacs" is
~https://github.com/grtcdr/grtcdr.tn/blob/main/posts/2022-05-18.org~.
...
- Choosing =ox-publish= as my static site builder was a really, really
  great choice.
- Knowing the lingo goes a long way in helping you research any
  particular topic.
